...
public class MyBatisEquipoDAO implements EquipoDAO{	
	...
	public void insertarEquipoSinLaboratorio(int id,Date fechainicioactividad,Date fechafinactividad,Date fechaadquisicion) 
		...
		if(getEquipo(id)!=null) throw new ECILabException("Error: Ya existe un equipo con este mismo ID.");		
		if(fechafinactividad != null) throw new ECILabException("Error: El equipo debe estar activo.");	
	...
	public void asociarElemento(int idElemento, int IdEquipoN)throws ECILabException{
		...
		if(e==null) throw new ECILabException("Error: El equipo no se encuetra registrado.");
		if(e.getFechaFinActividad()!=null) throw new ECILabException("Error: El equipo que fue dado de baja no se le pueden asociar elementos.");
