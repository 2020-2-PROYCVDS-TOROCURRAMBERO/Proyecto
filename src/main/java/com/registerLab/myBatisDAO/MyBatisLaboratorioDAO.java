...
public class MyBatisLaboratorioDAO implements LaboratorioDAO{	
	...
	public void asociarEquipo(int idEquipo, int idLaboratorioN) throws ECILabException{
		...
		if(e==null) throw new ECILabException("Error: El equipo no se encuentra registrado.");
	...
	public void agregarLaboratorio(int id, String nombre, int capacidad, Date fechacierre, Date fechaapertura) throws ECILabException {
		if (getLaboratorio(id) != null) throw new ECILabException ("Error: Este laboratorio ya se encuentra registrado.");
		if (nombre == null || nombre == "") throw new ECILabException ("Error: El nombre del laboratorio no puede estar vacio.");
